...
namespace phpManufaktur\kitConnect\unZip;

use phpManufaktur\kitConnect\unZip\unZipException;

if (!defined('WB_PATH'))
	exit('Can\'t access this file directly!');

require_once WB_PATH.'/modules/kit_connect/Setup/unZip/unZipException.php';
